package com.yph.config.admin;
/**
 * 用来配置拦截器的配置类
 */

import com.yph.admin.interceptor.AuthorityInterceptor;
import com.yph.admin.interceptor.LoginInterceptor;
import com.yph.constant.RuntimeConstant;
